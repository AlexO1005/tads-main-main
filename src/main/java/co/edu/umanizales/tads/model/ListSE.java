...
public class ListSE {
    ...
    //5 obtener el promedio promedio de edad de los ninos de la lista
    ...
    public void getReport(int age) {
    }

    public void orderKidsToStart() {
    }

    public void sendKidFinalByLetter(char code) {
    }

    public int getKids(String code) {
        return 0;
    }
}